    ...
    <div class="col-md-8 offset-md-2">
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <form action="../../CommoditeServlet" method="POST" onsubmit="return confirmerSuppression()">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-6">
                      ...
                      <button type="button" class="btn btn-sm btn-outline-info" disabled>
                        <i class="fas fa-eye"></i> Voir commodités par chambre (à venir)
                      </button>
                    </div>
                  </div>
                </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <small>
                ...
                <a href="../../CommoditeServlet?action=afficherFormInclure">Inclure une commodité</a>
              </small>
            </div>
