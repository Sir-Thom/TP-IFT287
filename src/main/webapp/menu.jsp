...
<div style="width:100%; height:400px; overflow:hidden;">
  <img src="<%= request.getContextPath() %>/assets/header-bg.jpg"
       alt="image du inn"
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ChambreServlet?action=afficherFormAjouter" class="btn Bouton">Accéder</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ChambreServlet?action=afficherFormSupprimer" class="deleteButton">
                🔥 DÉTRUIRE 🔥
              </a>
            </div>
          </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ChambreServlet?action=afficherFormRecherche" class="btn Bouton">Accéder</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ChambreServlet?action=afficherFormChambresLibres" class="btn Bouton">Accéder</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ClientServlet?action=afficherFormAjouter" class="btn Bouton">Accéder</a>
            </div>
          </div>
        </div>
        <!-- RETIRER CLIENT -->
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ClientServlet?action=afficherFormAjouter" class="deleteButton">🔥 DÉTRUIRE 🔥</a>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-4 mb-4">
          <div class="card menu-card text-center">
            <div class="card-body">
              ...
              <a href="ClientServlet?action=lister" class="btn Bouton">Accéder</a>
            </div>
          </div>
        </div>
      </div>
